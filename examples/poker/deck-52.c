...
const char * const nominal52_str = "23456789TJQKA";
const char * const card52_str[] = {
    "2h", "2d", "2c", "2s",
    "3h", "3d", "3c", "3s",
    "4h", "4d", "4c", "4s",
    "5h", "5d", "5c", "5s",
...
uint64_t eval_rank5_via_robust_for_deck52(const card_t * const cards)
{
    ...
    for (int n=NOMINAL_2; n<=NOMINAL_A; ++n) {
        ...
        const int shift = n + 13*nominal_stat[n] - 13;
        rank |= 1ull << shift;
    }
...
const card_t quick_ordered_hand5_for_deck52[] = {
    ...
    CARD_4s, CARD_4c, CARD_6c, CARD_Qd, CARD_As,
    CARD_Ts, CARD_Tc, CARD_2c, CARD_7d, CARD_8c,
    CARD_4s, CARD_4d, CARD_Js, CARD_Jc, CARD_Ad,
    CARD_As, CARD_Ah, CARD_Kh, CARD_Kc, CARD_4c,
    CARD_Jc, CARD_Jd, CARD_Jh, CARD_9c, CARD_2h,
    CARD_Ks, CARD_Kc, CARD_Kd, CARD_Qs, CARD_5d,
    CARD_As, CARD_5c, CARD_4d, CARD_3h, CARD_2h,
    CARD_6c, CARD_7c, CARD_8c, CARD_9s, CARD_Ts,
    CARD_Ad, CARD_Kc, CARD_Qs, CARD_Js, CARD_Ts,
    CARD_As, CARD_Qs, CARD_Ts, CARD_4s, CARD_3s,
    CARD_Ad, CARD_Kd, CARD_Td, CARD_5d, CARD_2d,
    CARD_5s, CARD_5c, CARD_5h, CARD_As, CARD_Ad,
    CARD_Js, CARD_Jd, CARD_Jh, CARD_6s, CARD_6d,
    CARD_4c, CARD_4s, CARD_4d, CARD_4h, CARD_6c,
    CARD_4s, CARD_4c, CARD_4d, CARD_4h, CARD_Kc,
    CARD_Ad, CARD_2d, CARD_3d, CARD_4d, CARD_5d,
    CARD_5c, CARD_9c, CARD_8c, CARD_7c, CARD_6c,
...
const card_t quick_ordered_hand7_for_deck52[] = {
    CARD_2h, CARD_3c, CARD_4c, CARD_5c, CARD_7s, CARD_8d, CARD_9d,
    CARD_3h, CARD_5d, CARD_7c, CARD_9c, CARD_Js, CARD_Qh, CARD_2h,
    CARD_4s, CARD_4c, CARD_6c, CARD_Qd, CARD_As, CARD_5c, CARD_Jd,
    CARD_Ts, CARD_Tc, CARD_2c, CARD_7d, CARD_8c, CARD_2h, CARD_Kh,
    CARD_4s, CARD_4d, CARD_Js, CARD_Jc, CARD_Ad, CARD_2s, CARD_3s,
    CARD_As, CARD_Ah, CARD_Kh, CARD_Kc, CARD_4c, CARD_2s, CARD_2d,
    CARD_Jc, CARD_Jd, CARD_Jh, CARD_9c, CARD_2h, CARD_3d, CARD_8d,
    CARD_Ks, CARD_Kc, CARD_Kd, CARD_Qs, CARD_5d, CARD_6d, CARD_7d,
    CARD_As, CARD_5c, CARD_4d, CARD_3h, CARD_2h, CARD_Kd, CARD_Ks,
    CARD_6c, CARD_7c, CARD_8c, CARD_9s, CARD_Ts, CARD_Qh, CARD_2h,
    CARD_Ad, CARD_Kc, CARD_Qs, CARD_Js, CARD_Ts, CARD_Td, CARD_Th,
    CARD_As, CARD_Qs, CARD_Ts, CARD_4s, CARD_3s, CARD_Ad, CARD_Ah,
    CARD_Ad, CARD_Kd, CARD_Td, CARD_5d, CARD_2d, CARD_3d, CARD_Ks,
    CARD_5s, CARD_5c, CARD_5h, CARD_As, CARD_Ad, CARD_Ks, CARD_Kd,
    CARD_Js, CARD_Jd, CARD_Jh, CARD_6s, CARD_6d, CARD_2h, CARD_3h,
    CARD_4c, CARD_4s, CARD_4d, CARD_4h, CARD_6c, CARD_2c, CARD_3c,
    CARD_4s, CARD_4c, CARD_4d, CARD_4h, CARD_Kc, CARD_Kh, CARD_Kd,
    CARD_Ad, CARD_2d, CARD_3d, CARD_4d, CARD_5d, CARD_7d, CARD_8h,
    CARD_5c, CARD_9c, CARD_8c, CARD_7c, CARD_6c, CARD_2h, CARD_2d,
    CARD_2s, CARD_2d, CARD_Kh, CARD_Qh, CARD_Jh, CARD_Th, CARD_9h,
    CARD_Ah, CARD_Kh, CARD_3s, CARD_Jd, CARD_Qh, CARD_Jh, CARD_Th,
    0xFF
};

const card_t quick_ordered_hand7_for_omaha[] = {
    CARD_2s, CARD_3d, CARD_4d, CARD_9d, CARD_8d, CARD_7s, CARD_6s,
    CARD_Ah, CARD_Qh, CARD_Td, CARD_8d, CARD_7s, CARD_6h, CARD_5h,
    CARD_2s, CARD_4s, CARD_6s, CARD_8d, CARD_Ts, CARD_2d, CARD_Ad,
    CARD_8c, CARD_8h, CARD_2c, CARD_3h, CARD_Jd, CARD_As, CARD_Ks,
    CARD_2d, CARD_8d, CARD_Ah, CARD_Ks, CARD_2s, CARD_Jd, CARD_Jh,
    CARD_As, CARD_Kc, CARD_Th, CARD_8d, CARD_2s, CARD_Td, CARD_Ad,
    CARD_As, CARD_8s, CARD_8h, CARD_8d, CARD_Ac, CARD_2c, CARD_3c,
    CARD_Kd, CARD_As, CARD_2s, CARD_3h, CARD_Js, CARD_Ks, CARD_Kc,
    CARD_4d, CARD_3s, CARD_2h, CARD_Js, CARD_Ad, CARD_5d, CARD_As,
    CARD_6d, CARD_5h, CARD_7h, CARD_2s, CARD_As, CARD_4h, CARD_8h,
    CARD_As, CARD_2d, CARD_Qs, CARD_2s, CARD_5d, CARD_Js, CARD_3s,
    CARD_2c, CARD_3c, CARD_5c, CARD_2s, CARD_2h, CARD_Ac, CARD_Kc,
    CARD_2s, CARD_2d, CARD_8s, CARD_9d, CARD_Th, CARD_8d, CARD_8c,
    CARD_As, CARD_Ad, CARD_Ac, CARD_2d, CARD_2h, CARD_3c, CARD_3h,
    CARD_2s, CARD_2h, CARD_Js, CARD_Ks, CARD_Qs, CARD_2d, CARD_2c,
    CARD_8s, CARD_Js, CARD_7c, CARD_8d, CARD_Jd, CARD_Jh, CARD_Jc,
    CARD_2h, CARD_3h, CARD_Ad, CARD_As, CARD_5h, CARD_6h, CARD_4h,
    CARD_2h, CARD_Ad, CARD_6h, CARD_Td, CARD_Jd, CARD_Qd, CARD_Kd,
    0xFF
};
